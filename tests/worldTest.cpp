...
//probador de grabar y cargar
	//probando a grabar en un fichero el prismatic part, despues lo a�ado
/*	if(1){
...
void InitWorldSquaredRingNoWalls()
{
	...
	Face paredexterna1(Transformation3D(-20,0,0,Y_AXIS,PI/2),-5,-10,0,10); //a�adida por el problema con las glut
	paredexterna1.setColor(0.5f, 0.5f, 0.0f, 1);
...
/*	pruebaLaser=new NemoLaserSensor3DSim;
	...
	pruebaLaser->updateSensorData(); //actualizo las medidas para la primera impresi�n
