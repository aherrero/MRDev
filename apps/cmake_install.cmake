# Install script for directory: /home/alex/mrdevgit/apps
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/mrcore/bin/simulator" AND
    ...
    FILE(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/local/mrcore/bin/simulator"
         RPATH "")
  ENDIF()
  list(APPEND CPACK_ABSOLUTE_DESTINATION_FILES
   "/usr/local/mrcore/bin/simulator")
FILE(INSTALL DESTINATION "/usr/local/mrcore/bin" TYPE EXECUTABLE FILES "/home/alex/mrdevgit/apps/simulator")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/mrcore/bin/simulator" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/mrcore/bin/simulator")
    FILE(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/mrcore/bin/simulator")
    IF(CMAKE_INSTALL_DO_STRIP)
      EXECUTE_PROCESS(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/local/mrcore/bin/simulator")
...
FILE(WRITE "/home/alex/mrdevgit/apps/${CMAKE_INSTALL_MANIFEST}" "")
FOREACH(file ${CMAKE_INSTALL_MANIFEST_FILES})
  FILE(APPEND "/home/alex/mrdevgit/apps/${CMAKE_INSTALL_MANIFEST}" "${file}\n")
ENDFOREACH(file)
